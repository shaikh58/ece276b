...
def runtest(mapfile, start, goal, verbose = True):
  ...
  return success, pathlength, blocks
...
if __name__=="__main__":
  # start = np.array([2.3, 2.3, 1.3])
  # goal = np.array([7.0, 7.0, 5.5])
  # success, pathlength, blocks = runtest('./maps/single_cube.txt', start, goal, verbose=True)
  # test_single_cube()
  # test_maze()
  # test_flappy_bird()
  # test_monza()
  ...
  # test_line_start = np.array([2,2,2])
  # test_line_end = np.array([2.5,2.5,2.5])
  # line_intersects_cube(test_line_start,test_line_end,blocks)
